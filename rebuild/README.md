...
- `first-100-hours-progression-tree.md` - first 100 hours progression tree, power spike cadence, and idle fallback plan.
- `prestige-model.md` - layered reset model covering lite prestige, full legacy prestige, and later feature refresh prestiges.
- `time-gated-progression.md` - pure elapsed-time progression systems that reward all players and help stuck players keep moving.
- `challenge-model.md` - prestige-started challenge runs with restrictions, 5-level completions, and permanent rewards.
